    ...
    public static void main(String args[]){
     ...
     double a,b;
         ...
         for(j=1;j<n;j++){
            ...
            // P[j]=p;
             for(k2=0;k2<n;k2++){
               printX[j][k2]=printX[k1][k2];
               printY[j][k2]=printY[k1][k2]; 
             }
            printX[j][k1]=X[3];
               printY[j][k1]=Y[3] ;
                   }
                           
         System.out.println("partitions"+P[99]);
               for(int k3=0;k3<P[99];k3++){
               System.out.println("partion will start from  ("+X[k3]+","+Y[k3]+")");
